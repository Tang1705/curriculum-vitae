...
!function (e) {
    ...
    return function n(a, o, u) {
        ...
        1: [function (e, t, r) {
            var p = e("github-calendar-parser"), b = e("elly"), g = e("add-subtract-date"), m = e("formatoid"),
                h = "MMM D, YYYY", y = "MMMM D",
                ...
                return f.proxy = f.proxy || function (e) {
                    ...
                    return f.getCalendar(e).then(function (e) {
                        var t, n, r = document.createElement("div"),
                            ...
                            a = (b(".position-relative h2", e).remove(), !0), o = !1, u = void 0;
                        try {
            ...
            var n = e("iterate-object"), a = e("sliced");
            ...
            var n = e("months"), a = e("days"), o = e("fillo"), e = e("parse-it").Parser, u = {
                YYYY: function (e, t) {
            ...
            t.exports = function (e) {
                ...
                return e.split("\n").slice(2).map(function (e) {
                    ...
                    var t = e.match(/data-level="([0-9\-]+)"/i), r = e.match(/data-date="([0-9\-]+)"/),
                        e = e.match(/(No|[0-9]+)( contribution)/), t = t && t[1], r = r && r[1],
            ...
            t.exports = function (e, t) {
                var r, n = 0;
                if (Array.isArray(e)) for (; n < e.length && !1 !== t(e[n], n, e); ++n) ; else if ("object" === (void 0 === e ? "undefined" : a(e)) && null !== e) for (r = Object.keys(e); n < r.length && !1 !== t(e[r[n]], r[n], e); ++n) ;
            }
        }, {}], 10: [function (e, t, r) {
            ...
            var o = e("regex-escape"), u = (n(s, [{
                key: "run", value: function (e, t) {
                    var r = "";
                    t = t || [];
                    do {
                        var n = e.match(this.re), n = n && n[1], a = n || e.charAt(0)
